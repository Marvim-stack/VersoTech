...
-- Cria as tabelas de origem (dados "sujos") e popula com dados

SET search_path TO public;

DROP TABLE IF EXISTS precos_base;
...
-- CHECK (opcional)
-- =========================
SELECT 'produtos_base' AS tabela, COUNT(*) AS total FROM produtos_base
UNION ALL
SELECT 'precos_base' AS tabela, COUNT(*) AS total FROM precos_base;
